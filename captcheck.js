window.onload = function() { // unminified and placed here as reference
    function m(c, g) {
    ...
    function n(c) {
        var g = document.getElementById("captcheck_" + c + "_alt_question_button")
          , b = document.getElementById("captcheck_" + c + "_question_image")
          , d = document.getElementById("captcheck_" + c + "_question_access")
          , f = document.getElementById("captcheck_" + c + "_answer_images");
        c = document.getElementById("captcheck_" + c + "_answer_access");
        "&gt; Text mode" == g.innerHTML ? (g.innerHTML = "&gt; Image mode",
        b.style.display = "none",
        d.style.display = "initial",
        f.style.display = "none",
        c.style.display = "initial",
            c.innerHTML = "<input type='text' name='captcheck_selected_answer' aria-label='Type your answer here.'" +
            "autocomplete= 'off' autofill = 'off' /> ") : (g.innerHTML = " & gt; Text mode",
                    ...
                    if (200 == b) {
                        ...
                        for (e = 0; e < f.length; e++)
                            ...
                            f[e].addEventListener("keydown", function(a) {
                                if ("Enter" === a.key || 13 === a.which || 13 === a.keyCode || " " === a.key || 32 === a.which || 32 === a.keyCode)
                                    m(a.target.getAttribute("data-prefix"), a.target.getAttribute("data-answer")),
                                    a.preventDefault()
                            });
                        ...
                        f.innerHTML = "<span class='captcheck_error_message'>There was a problem loading the CAPTCHA.</span>"
                }
            }
        }
        ;
    ...
    l.innerHTML = `.captcheck_box{
        font-family:Ubuntu,Arial,sans-serif;
        color:black; border:1px solid #e0e0e0;
        border-radius:3px; display:inline-block;
        padding:3px; margin:5px 2px 5px 1px;
        background-color:#f5f5f5; text-decoration:none
    }
    .captcheck_label_message,.captcheck_label_message b{
        color:black;font-family:Ubuntu,Roboto,Arial,sans-serif }
    ...
    .captcheck_answer_label>input+img{
        ...
        border-radius:3px; min-width:32px; width:18%; max-width:64px
    }
    .captcheck_answer_label>input:checked+img{
        cursor:pointer; border:2px solid #424242; border-radius:3px
    }
    ...
    .captcheck_alt_question_button{
        float:right; font-size:80%; cursor:pointer; color:inherit;
        text-decoration:inherit; border:0
    }
