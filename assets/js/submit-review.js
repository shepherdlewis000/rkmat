$(function () {
    ...
    console.log("Entered submit-review.js");
    $('#better-rating-form').validator();
    ...
    // when the form is submitted
        $('#better-rating-form').on('submit', function (e) {
            ...
            const getRating = () => $("input[type=hidden][name=rating]").val();
            console.log("submit-review.js:192 rating is: " + getRating());
            ...
            if (!e.isDefaultPrevented()) {
                ...
                if (getRating() == "0") {
                    ...
                    var messageText = "You must assign 1 to 5 stars!";
                    var alertBox = '<div class="alert ' + messageAlert + ' alert-dismissable"><button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>' + messageText + '</div>';
                    console.log("submit-review.js:216")
                ...
                const myto = setTimeout(() => {
                    //const currChoice2 = getCurrChoice();//console.log("contact.js:163 currChoice is now: " + currChoice2);
